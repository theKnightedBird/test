...
/*---------------------------------------------------------------------------*/
void robot_link::set_remote_location(float x, float y, float heading, int32_t status)
{
  txlock.lock();
...
/*---------------------------------------------------------------------------*/
void robot_link::get_local_location(float &x, float &y, float &heading, int32_t &status)
{
  txlock.lock();
...
/*---------------------------------------------------------------------------*/
void robot_link::get_remote_location(float &x, float &y, float &heading)
{
  rxlock.lock();
...
/*---------------------------------------------------------------------------*/
bool robot_link::process(uint8_t data)
{
...
/*---------------------------------------------------------------------------*/
int robot_link::rx_task(void *arg)
{
  uint8_t buffer[128];
...
/*---------------------------------------------------------------------------*/
int robot_link::tx_task(void *arg)
{
  if (arg == NULL)
    return (0);
